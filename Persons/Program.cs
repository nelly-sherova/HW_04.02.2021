...
namespace Persons
{
    class Program
    {
        ...
        {
            const string connectionString = @"Data source=NILUFARSHEROVA; Initial catalog=Persons; Integrated Security = True";
            ...
            while (counter != 0 )
            {
                switch (counter)
                {
                    case 1:
                    {
                        ...
                        string sqlInsert = $"INSERT INTO Person ([FirstName],[LastName], [MiddleName], [BirthDate]) VALUES ( '{FirstName}', '{LastName}', '{MiddleName}' , '{Birthdate}')";
                    ...
                    break;
                    case 2:
                    string sqlExpression1 = "SELECT * FROM Person";
                    using (SqlConnection connection1 = new SqlConnection(connectionString))
                    {
                        ...
                        while (reader.Read()) 
                            Console.WriteLine($"ID: {reader.GetValue(0)}, Firstname:{reader.GetValue(1)} | LastName:{reader.GetValue(2)} | MiddleName:{reader.GetValue(3)} | BirthDate:{reader.GetValue(4)}");
                    ...
                    string  sqlExpressionn = $"Select * from Person where Person.Id = {iD}";
                    ...
                    string sqlExpression3 = $"DELETE  FROM Person WHERE Id ='{i}'";
                    ...
                    switch (line)
                    {
                        case 1: 
                            ...
                            string sqlExpression4 = $"UPDATE Person SET FirstName = '{name1}'  WHERE FirstName ='{name}'";
                        ...
                        case 2: 
                            ...
                            string sqlExpression42 = $"UPDATE Person SET LastName = '{surname1}'  WHERE LastName ='{surname}'";
                        ...
                        case 3: 
                            ...
                            string sqlExpression43 = $"UPDATE Person SET MiddleName = '{midname1}'  WHERE MiddleName ='{midname}'";
